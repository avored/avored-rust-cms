...
impl SecurityAlertRepository {
    ...
    pub async fn create(
        ...
        let vars: BTreeMap<String, Value> = [
            ("alert_id".into(), createable_security_alert_model.alert_id.into()),
            ("alert_type".into(), createable_security_alert_model.alert_type.as_str().into()),
            ("severity".into(), createable_security_alert_model.severity.as_str().into()),
            ("message".into(), createable_security_alert_model.message.into()),
            ("source".into(), createable_security_alert_model.source.into()),
            ("affected_resource".into(), match createable_security_alert_model.affected_resource {
                Some(val) => val.into(),
                None => Value::None,
            }),
            ("metadata".into(), match createable_security_alert_model.metadata {
        ...
        let result_object = match result_object_option {
            Some(object) => object,
            None => return Err(Error::Generic("Failed to create security alert record".to_string())),
        };
    ...
    pub async fn find_by_id(
        ...
        let result_object = match result_object_option {
            Some(object) => object,
            None => return Err(Error::Generic("Security alert record not found".to_string())),
        };
    ...
    pub async fn find_unresolved_by_severity(
        ...
        let count_vars: BTreeMap<String, Value> = [("severity".into(), severity.as_str().into())].into();
    ...
    pub async fn find_by_alert_type(
        ...
        // Get total count
        let count_sql = "SELECT count() FROM security_alerts WHERE alert_type = $alert_type GROUP ALL;";
        let count_vars: BTreeMap<String, Value> = [("alert_type".into(), alert_type.as_str().into())].into();
        let count_responses = datastore.execute(count_sql, database_session, Some(count_vars)).await?;
    ...
    pub async fn update(
        ...
        let result_object = match result_object_option {
            Some(object) => object,
            None => return Err(Error::Generic("Failed to update security alert record".to_string())),
        };
    ...
    pub async fn resolve(
        ...
        self.update(datastore, database_session, id, update_model).await
    }
