...
pub mod auth_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn login_user(
            ...
            let path = http::uri::PathAndQuery::from_static("/auth_user.Auth/LoginUser");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("auth_user.Auth", "LoginUser"));
...
pub mod auth_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/auth_user.Auth/LoginUser" => {
                    #[allow(non_camel_case_types)]
                    struct LoginUserSvc<T: Auth>(pub Arc<T>);
                    ...
                    for LoginUserSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Auth>::login_user(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "auth_user.Auth";
