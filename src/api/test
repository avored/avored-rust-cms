...
pub struct AdminUserModel {
    ...
    /// admin user updated at
    pub updated_at: ::core::option::Option<::prost_types::Timestamp>,
    #[prost(string, tag = "8")]
    /// admin user created by
    pub created_by: ::prost::alloc::string::String,
    #[prost(string, tag = "9")]
    /// admin user updated by
...
pub struct RoleOptionModel {
    #[prost(string, tag = "1")]
    /// role option model lable
    pub label: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    /// role option model value
    pub value: ::prost::alloc::string::String,
}
/// Admin user paginate API
#[derive(Clone, PartialEq, Eq, ::prost::Message)]
/// admin user paginate request
pub struct AdminUserPaginateRequest {
    #[prost(int64, optional, tag = "1")]
    /// admin user paginate request page
    pub page: ::core::option::Option<i64>,
    /// admin user paginate request order
    #[prost(string, optional, tag = "2")]
    pub order: ::core::option::Option<::prost::alloc::string::String>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
/// admin uer paginate response
pub struct AdminUserPaginateResponse {
    /// admin user paginate response status
    #[prost(bool, tag = "1")]
    pub status: bool,
    #[prost(message, optional, tag = "2")]
    /// admin user paginate response data list of models
...
pub mod admin_user_paginate_response {
    ...
    pub struct AdminUserPaginateData {
        ...
        /// admin user paginate paginations
        pub pagination: ::core::option::Option<AdminUserPagination>,
        #[prost(message, repeated, tag = "2")]
        /// admin user paginate data or list of admin user models
...
pub struct StoreAdminUserRequest {
    #[prost(string, tag = "1")]
    /// store admin user request full name
    pub full_name: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    /// store admin user request email
    pub email: ::prost::alloc::string::String,
    #[prost(string, tag = "3")]
    /// store admin user request password
    pub password: ::prost::alloc::string::String,
    #[prost(string, tag = "4")]
    /// store admin user request confirm passowrd
    pub confirm_password: ::prost::alloc::string::String,
    #[prost(bool, tag = "5")]
    /// store admin user request super admin
    pub is_super_admin: bool,
    #[prost(bytes = "vec", tag = "6")]
    /// store admin user request profile image content
    pub profile_image_content: ::prost::alloc::vec::Vec<u8>,
    #[prost(string, tag = "7")]
    /// store admin user request profile image name
...
pub struct StoreAdminUserResponse {
    #[prost(bool, tag = "1")]
    /// store admin user response status
    pub status: bool,
    #[prost(message, optional, tag = "2")]
    /// store admin user response admin user model
...
pub struct GetAdminUserRequest {
    #[prost(string, tag = "1")]
    /// get admin user request admin user id
...
pub struct GetAdminUserResponse {
    #[prost(bool, tag = "1")]
    /// get admin user response status
    pub status: bool,
    #[prost(message, optional, tag = "2")]
    /// get admin user response admin user model
    pub data: ::core::option::Option<AdminUserModel>,
}
#[derive(Clone, PartialEq, Eq, ::prost::Message)]
/// update admin user mdoel 
pub struct UpdateAdminUserRequest {
    #[prost(string, tag = "1")]
    /// update admin user mdoel admin user id
    pub admin_user_id: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    /// update admin user mdoel full name
    pub full_name: ::prost::alloc::string::String,
    #[prost(bytes = "vec", tag = "3")]
    /// update admin user mdoel profile content
    pub profile_image_content: ::prost::alloc::vec::Vec<u8>,
    #[prost(string, tag = "4")]
    /// update admin user mdoel profile image
    pub profile_image_file_name: ::prost::alloc::string::String,
    #[prost(string, repeated, tag = "5")]
    /// update admin user mdoel roleids
    pub role_ids: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
    #[prost(bool, tag = "6")]
    /// update admin user mdoel superadmin
    pub is_super_admin: bool,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct UpdateAdminUserResponse {
    #[prost(bool, tag = "1")]
    /// update admin user response status
    pub status: bool,
    #[prost(message, optional, tag = "2")]
    /// update admin user response admin user model
    pub data: ::core::option::Option<AdminUserModel>,
}
#[derive(Clone, PartialEq, Eq, ::prost::Message)]
...
pub struct RolePaginateRequest {
    #[prost(int64, optional, tag = "1")]
    /// role paginate request page
    pub page: ::core::option::Option<i64>,
    #[prost(string, optional, tag = "2")]
    /// role paginate request order
    pub order: ::core::option::Option<::prost::alloc::string::String>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct RolePaginateResponse {
    #[prost(bool, tag = "1")]
    /// role paginate response data status
    pub status: bool,
    #[prost(message, optional, tag = "2")]
    /// role paginate response data list of paginate
...
pub mod role_paginate_response {
    ...
    pub struct RolePaginateData {
        #[prost(message, optional, tag = "1")]
        /// role paginate data pagination
        pub pagination: ::core::option::Option<RolePagination>,
        #[prost(message, repeated, tag = "2")]
        /// role paginate data role model list
        pub data: ::prost::alloc::vec::Vec<super::RoleModel>,
    }
}
#[derive(Clone, PartialEq, Eq, ::prost::Message)]
/// role option response 
pub struct RoleOptionResponse {
    #[prost(bool, tag = "1")]
    /// role option response status
    pub status: bool,
    #[prost(message, repeated, tag = "2")]
    /// role option response data list
...
pub struct StoreRoleRequest {
    #[prost(string, tag = "1")]
    /// store role request name
    pub name: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    /// store role request idenfier
    pub identifier: ::prost::alloc::string::String,
    #[prost(string, repeated, tag = "3")]
    /// store role request permissions list
    pub permissions: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
}
#[derive(Clone, PartialEq, Eq, ::prost::Message)]
/// store role response 
pub struct StoreRoleResponse {
    #[prost(bool, tag = "1")]
    /// store role response status
    pub status: bool,
    #[prost(message, optional, tag = "2")]
    /// store role response data
...
pub struct UpdateRoleRequest {
    ...
    pub role_id: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    /// update role request name
    pub name: ::prost::alloc::string::String,
    #[prost(string, repeated, tag = "3")]
    /// update role request permission list
    pub permissions: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
}
#[derive(Clone, PartialEq, Eq, ::prost::Message)]
/// update role 
...
pub struct PutRoleIdentifierRequest {
    #[prost(string, tag = "1")]
    /// put role identifier request role_id
    pub role_id: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    /// put role identifier request identifier
    pub identifier: ::prost::alloc::string::String,
}
#[derive(Clone, PartialEq, Eq, ::prost::Message)]
/// put role identifier 
pub struct PutRoleIdentifierResponse {
    #[prost(bool, tag = "1")]
    /// put role identifier status
    pub status: bool,
    #[prost(message, optional, tag = "2")]
    /// put role identifier response data
    pub data: ::core::option::Option<RoleModel>,
}
#[derive(Clone, PartialEq, Eq, ::prost::Message)]
/// delete role request
...
pub struct DeleteAdminUserRequest {
    #[prost(string, tag = "1")]
    /// delete admin user request admin user id 
    pub admin_user_id: ::prost::alloc::string::String,
}
#[derive(Clone, Copy, PartialEq, Eq, ::prost::Message)]
...
pub struct DeleteAdminUserResponse {
    #[prost(bool, tag = "1")]
    /// delete admin user response status
    pub status: bool,
}
#[derive(Clone, Copy, PartialEq, Eq, ::prost::Message)]
/// role options request
