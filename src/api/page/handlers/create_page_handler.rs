...
pub async fn create_page_handler(
    ...
    println!("->> {:<12} - page_create_handler", "HANDLER");
    ...
    let view_model = CreatePageViewModel {
        logged_in_user,
    ...
    let html = handlebars
        ...
        .expect(
            "there is an issue with handlebar rendering page/create-page.hbs template",
        );
...
pub struct CreatePageViewModel {
