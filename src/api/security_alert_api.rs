...
use crate::api::proto::security_audit::{
    ...
    GetSecurityAlertRequest, GetSecurityAlertResponse,
    GetUnresolvedAlertsBySeverityRequest, GetUnresolvedAlertsBySeverityResponse,
    GetAlertsByTypeRequest, GetAlertsByTypeResponse,
    GetAlertsBySourceRequest, GetAlertsBySourceResponse,
    ...
    GetCriticalUnresolvedAlertsRequest, GetCriticalUnresolvedAlertsResponse,
    DeleteSecurityAlertRequest, DeleteSecurityAlertResponse,
    GetAlertStatisticsRequest, GetAlertStatisticsResponse,
};
...
impl SecurityAlert for SecurityAlertApi {
    async fn create_security_alert(
        ...
        println!("->> {:<12} - create_security_alert", "gRPC_SecurityAlert_Service");
    ...
    async fn create_security_alert_auto_id(
        ...
        println!("->> {:<12} - create_security_alert_auto_id", "gRPC_SecurityAlert_Service");
    ...
    async fn get_security_alert(
        ...
        println!("->> {:<12} - get_security_alert", "gRPC_SecurityAlert_Service");
    ...
    async fn get_unresolved_alerts_by_severity(
        ...
        println!("->> {:<12} - get_unresolved_alerts_by_severity", "gRPC_SecurityAlert_Service");
        ...
        match self
            .state
            .security_alert_service
            .get_unresolved_alerts_by_severity_grpc(req.severity, req.page, req.per_page, &self.state.db)
            .await
        {
            Ok(reply) => Ok(Response::new(reply)),
            Err(e) => match e {
    ...
    async fn get_alerts_by_type(
        ...
        println!("->> {:<12} - get_alerts_by_type", "gRPC_SecurityAlert_Service");
    ...
    async fn get_alerts_by_source(
        ...
        println!("->> {:<12} - get_alerts_by_source", "gRPC_SecurityAlert_Service");
    ...
    async fn resolve_security_alert(
        ...
        println!("->> {:<12} - resolve_security_alert", "gRPC_SecurityAlert_Service");
    ...
    async fn get_security_alerts_paginated(
        ...
        println!("->> {:<12} - get_security_alerts_paginated", "gRPC_SecurityAlert_Service");
    ...
    async fn get_critical_unresolved_alerts(
        ...
        println!("->> {:<12} - get_critical_unresolved_alerts", "gRPC_SecurityAlert_Service");
    ...
    async fn delete_security_alert(
        ...
        println!("->> {:<12} - delete_security_alert", "gRPC_SecurityAlert_Service");
    ...
    async fn get_alert_statistics(
        ...
        println!("->> {:<12} - get_alert_statistics", "gRPC_SecurityAlert_Service");
