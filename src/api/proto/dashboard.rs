...
pub mod dashboard_client {
    ...
    impl DashboardClient<tonic::transport::Channel> {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> DashboardClient<InterceptedService<T, F>>
        where
        ...
        ) -> std::result::Result<tonic::Response<super::DashboardResponse>, tonic::Status> {
...
pub mod dashboard_server {
    ...
    impl<T> Clone for DashboardServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "dashboard.Dashboard";
    impl<T> tonic::server::NamedService for DashboardServer<T> {
