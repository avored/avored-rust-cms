/// Security audit related types and logic.
...
pub struct SecurityAlertModel {
    ...
    #[prost(string, tag = "6")]
    /// Source of the alert, e.g., "system", "user", "network"
    pub source: ::prost::alloc::string::String,
    #[prost(string, optional, tag = "7")]
    /// Optional field for affected resource
    pub affected_resource: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(string, optional, tag = "8")]
    /// JSON string for metadata
    pub metadata_json: ::core::option::Option<::prost::alloc::string::String>,
    #[prost(bool, tag = "9")]
    /// Indicates if the alert is resolved
    pub resolved: bool,
...
#[derive(Clone, PartialEq, ::prost::Message)]
/// Security Audit Pagination Model
...
#[derive(Clone, PartialEq, Eq, ::prost::Message)]
/// Security Alert Pagination Model
...
pub struct AlertStatistics {
    ...
    /// Total critical unresolved alerts
...
#[derive(Clone, PartialEq, ::prost::Message)]
/// Create Security Audit Response
...
#[derive(Clone, PartialEq, Eq, ::prost::Message)]
/// Get Security Audit Request
pub struct GetSecurityAuditRequest {
    #[prost(string, tag = "1")]
    /// ID of the security audit to retrieve
    pub id: ::prost::alloc::string::String,
}
#[derive(Clone, PartialEq, ::prost::Message)]
/// Get Security Audit Response
...
#[derive(Clone, PartialEq, Eq, ::prost::Message)]
/// Get Security Audits by User Request
...
#[derive(Clone, PartialEq, ::prost::Message)]
/// get security audits by user response
...
#[derive(Clone, PartialEq, Eq, ::prost::Message)]
/// Get Security Audits by IP Request
...
#[derive(Clone, PartialEq, ::prost::Message)]
/// Get Security Audits by IP Response
...
#[derive(Clone, Copy, PartialEq, Eq, ::prost::Message)]
/// Get Security Audits Paginated Request
...
#[derive(Clone, PartialEq, ::prost::Message)]
/// Get Security Audits Paginated Response
...
#[derive(Clone, PartialEq, ::prost::Message)]
/// Update Security Audit Request
pub struct UpdateSecurityAuditRequest {
    #[prost(string, tag = "1")]
    /// ID of the security audit to update
    pub id: ::prost::alloc::string::String,
    #[prost(message, optional, tag = "2")]
    /// Update security audit model
...
#[derive(Clone, PartialEq, ::prost::Message)]
/// Update Security Audit Response
pub struct UpdateSecurityAuditResponse {
    #[prost(bool, tag = "1")]
    /// status
    pub status: bool,
    #[prost(message, optional, tag = "2")]
    /// Updated security audit data
    pub data: ::core::option::Option<SecurityAuditModel>,
}
#[derive(Clone, PartialEq, Eq, ::prost::Message)]
/// Delete Security Audit Request
pub struct DeleteSecurityAuditRequest {
    #[prost(string, tag = "1")]
    /// ID of the security audit to delete
    pub id: ::prost::alloc::string::String,
}
#[derive(Clone, Copy, PartialEq, Eq, ::prost::Message)]
/// Delete Security Audit Response
...
#[derive(Clone, PartialEq, Eq, ::prost::Message)]
/// Get IP Security Summary Request
pub struct GetIpSecuritySummaryRequest {
    #[prost(string, tag = "1")]
    /// IP address to get security summary for
    pub ip_address: ::prost::alloc::string::String,
}
#[derive(Clone, PartialEq, ::prost::Message)]
/// Get IP Security Summary Response
...
#[derive(Clone, PartialEq, Eq, ::prost::Message)]
/// create security alert auto id request
...
#[derive(Clone, Copy, PartialEq, Eq, ::prost::Message)]
/// get unresolved alerts by severity request
...
#[derive(Clone, PartialEq, ::prost::Message)]
/// get unresolved alerts by severity response
...
#[derive(Clone, Copy, PartialEq, Eq, ::prost::Message)]
/// get security alerts paginated request
...
#[derive(Clone, PartialEq, ::prost::Message)]
/// get security alerts paginated response
...
#[derive(Clone, Copy, PartialEq, Eq, ::prost::Message)]
/// get critical unresolved alerts request
pub struct GetCriticalUnresolvedAlertsRequest {}
#[derive(Clone, PartialEq, Eq, ::prost::Message)]
/// get critical unresolved alerts response
...
#[derive(Clone, Copy, PartialEq, Eq, ::prost::Message)]
/// delete security alert response
...
#[derive(Clone, Copy, PartialEq, Eq, ::prost::Message)]
/// get alert statistics request
pub struct GetAlertStatisticsRequest {}
#[derive(Clone, Copy, PartialEq, Eq, ::prost::Message)]
/// get alert statistics response
...
pub enum AlertType {
    ...
    /// attempt to breach data security
    DataBreachAttempt = 6,
...
pub mod security_audit_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> Result<tonic::Response<super::CreateSecurityAuditResponse>, tonic::Status>
        {
        ...
        ) -> Result<tonic::Response<super::LogSecurityEventResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> Result<tonic::Response<super::GetSecurityAuditResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> Result<tonic::Response<super::GetSecurityAuditsByIpResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> Result<tonic::Response<super::UpdateSecurityAuditResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> Result<tonic::Response<super::DeleteSecurityAuditResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> Result<tonic::Response<super::GetIpSecuritySummaryResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
...
pub mod security_alert_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> Result<tonic::Response<super::CreateSecurityAlertResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> Result<tonic::Response<super::GetSecurityAlertResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> Result<tonic::Response<super::GetAlertsByTypeResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> Result<tonic::Response<super::GetAlertsBySourceResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> Result<tonic::Response<super::ResolveSecurityAlertResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> Result<tonic::Response<super::DeleteSecurityAlertResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> Result<tonic::Response<super::GetAlertStatisticsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
