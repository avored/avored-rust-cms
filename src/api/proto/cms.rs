...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetCmsContentResponse {
    #[prost(bool, tag = "1")]
    pub status: bool,
    #[prost(message, optional, tag = "2")]
    pub data: ::core::option::Option<super::content::ContentModel>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SentContactFormRequest {
    #[prost(string, tag = "1")]
...
pub struct SentContactFormResponse {
    #[prost(bool, tag = "1")]
    pub status: bool,
}
...
pub mod cms_client {
    ...
    impl CmsClient<tonic::transport::Channel> {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::GetCmsContentResponse>, tonic::Status>
        {
        ...
        ) -> std::result::Result<tonic::Response<super::SentContactFormResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
...
pub mod cms_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/cms.Cms/GetCmsContent" => {
                    ...
                    let fut = async move {
                        let method = GetCmsContentSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                ...
                "/cms.Cms/SentContactForm" => {
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SentContactFormSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "cms.Cms";
    impl<T> tonic::server::NamedService for CmsServer<T> {
