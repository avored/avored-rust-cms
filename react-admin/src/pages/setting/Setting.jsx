                ...
                <div className="p-5">
                    ...
                    <div class="grid grid-cols-12 pt-3">
                        <div class="col-span-2 sm:border-0 border-r px-3">
                            <ul>
                                <li class="mt-5 bg-gray-200 rounded cursor-pointer 
                            ...
                            <form  onSubmit={handleSubmit}>
                                <div class="sm:items-center sm:justify-between">
                                    <InputField
                                        ...
                                        onChange={(e) => settingChange('general_site_name', e.target.value)}
                                        autoFocus
                                    />
                                </div>

                                <div class="flex">
                                    <button type="submit" class="mt-5 rounded-lg bg-primary-600 px-4 py-2 text-white">
                                        Save
                                    </button>
                                </div>
                            </form>
