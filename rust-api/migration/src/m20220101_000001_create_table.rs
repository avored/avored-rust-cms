        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(AdminUsers::CreatedBy).string().default(Value::String(Some(Box::new(String::from("CLI"))))))
                    .col(ColumnDef::new(AdminUsers::UpdatedBy).string().default(Value::String(Some(Box::new(String::from("CLI"))))))
                    .to_owned(),
            )
            .await
    }
