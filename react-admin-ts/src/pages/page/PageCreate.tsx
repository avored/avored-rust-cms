...
function PageCreate() {
  ...
  const getFormattedDate = (date: string): string => {
    ...
    var month = ("0" + (date_obj.getMonth() + 1)).slice(-2); // pad with leading zero if needed
    var day = ("0" + date_obj.getDate()).slice(-2); // pad with leading zero if needed
    ...
    if (page) {
      page.components_content.forEach((componentContent) => {
        componentContent.component_fields_content.forEach(
          ...
          (componentFieldContent: ComponentFieldContent) => {
