...
/* harmony import */ var _multi_select__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./multi-select */ "./resources/js/multi-select.js");


alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].plugin(_alpinejs_focus__WEBPACK_IMPORTED_MODULE_1__["default"]);

alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('multiselect', _multi_select__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  return {
    ...
    init: function init(fieldName) {
      var style = this.style;
      var originalSelect = this.$el;
      ...
      var textList = document.createElement('span');
      ...
      var itemGroups = originalSelect.querySelectorAll('optgroup');
      if (itemGroups.length > 0) {
        itemGroups.forEach(function (itemGroup) {
          return processItems(itemGroup);
        });
      } else {
        processItems(originalSelect);
      }
      function processItems(parent) {
        var items = parent.querySelectorAll('option');
        var subMenu = document.createElement('ul');
        var groupName = parent.getAttribute('label') || null;
        if (groupName) {
      ...
      Alpine.data('newSelect', function () {
        var _selectMenu, _countBadge, _search, _clearSearchBtn;
        return {
          open: false,
          ...
          regenerateTextItems: function regenerateTextItems() {
            var _this = this;
            this.selectedItems = [];
            ...
            this.items.forEach(function (item) {
              ...
              if (checkbox.checked) {
                _this.selectedItems.push(text);
                _this.selectedItemValues.push(checkbox.value);
              }
            });
            ...
            if (this.selectedItems.length === 0) {
              ...
              hiddenInput.value = this.selectedItemValues.join(',');
            }
          },
          selectTrigger: _defineProperty({}, '@click', function click() {
            this.open = !this.open;
            if (this.open) {
              //   this.$nextTick(() =>
          ...
          selectMenu: (_selectMenu = {}, _defineProperty(_selectMenu, 'x-show', function xShow() {
            return this.open;
          }), _defineProperty(_selectMenu, 'x-trap.scroll', function xTrapScroll() {
            return this.open;
          }), _defineProperty(_selectMenu, '@keydown.down', function keydownDown() {
            this.$focus.wrap().next();
          }), _defineProperty(_selectMenu, '@keydown.up', function keydownUp() {
            this.$focus.wrap().previous();
          }), _defineProperty(_selectMenu, 'x-transition', function xTransition() {}), _defineProperty(_selectMenu, '@keydown.escape.window', function keydownEscapeWindow() {
            this.open = false;
          }), _defineProperty(_selectMenu, '@click.away', function clickAway() {
            this.open = false;
          }), _defineProperty(_selectMenu, 'x-init', function xInit() {
            this.items = this.$el.querySelectorAll('li');
            this.regenerateTextItems();
          }), _selectMenu),
          checkBox: _defineProperty({}, '@change', function change() {
          ...
          countBadge: (_countBadge = {}, _defineProperty(_countBadge, 'x-show', function xShow() {
            return this.showCountBadge;
          }), _defineProperty(_countBadge, 'x-text', function xText() {
            return this.selectedItems.length;
          }), _countBadge),
          search: (_search = {}, _defineProperty(_search, '@keydown.escape.stop', function keydownEscapeStop() {
            this.filterBy = '';
            this.$el.blur();
          }), _defineProperty(_search, '@keyup', function keyup() {
            this.filterBy = this.$el.value;
          }), _search),
          clearSearchBtn: (_clearSearchBtn = {}, _defineProperty(_clearSearchBtn, '@click', function click() {
            this.filterBy = '';
          }), _defineProperty(_clearSearchBtn, 'x-show', function xShow() {
            return this.filterBy.length > 0;
          }), _clearSearchBtn),
          listItem: _defineProperty({}, 'x-show', function xShow() {
            return this.filterBy === '' || this.$el.innerText.toLowerCase().startsWith(this.filterBy.toLowerCase());
          }),
          groupTitle: _defineProperty({}, 'x-show', function xShow() {
            var _this2 = this;
            if (this.filterBy === '') return true;
            var atLeastOneItemIsShown = false;
            this.$el.nextElementSibling.querySelectorAll('li').forEach(function (item) {
              if (item.innerText.toLowerCase().startsWith(_this2.filterBy.toLowerCase())) atLeastOneItemIsShown = true;
            });
